...
function extractIdentifiers(line: string): string[] {
  ...
  const keywords = new Set([
    ...
    "drop", "index", "into", "values", "set", "null", "true",
    "false", "like", "between", "case", "when", "then", "else",
    "end", "cast", "is", "varchar", "int", "integer", "bigint",
    "text", "date", "timestamp", "boolean", "serial", "decimal",
    "numeric", "primary", "key", "references", "default",
    "current_timestamp", "unique", "constraint", "foreign",
  ]);
